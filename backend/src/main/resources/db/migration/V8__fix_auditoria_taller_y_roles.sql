-- Flyway V8: Arreglar triggers de Taller y Persona_Roles para capturar el usuario real y navegador
...
BEGIN
    ...
    BEGIN
        ...
        SELECT CAST(SESSION_CONTEXT(N'UserId') AS INT), 'Persona_Roles', d.ID_Persona_Roles, 'DELETE',
            (SELECT d.ID_persona, d.ID_roles FOR JSON PATH, WITHOUT_ARRAY_WRAPPER), NULL,
